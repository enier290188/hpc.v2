...
@security_decorators.required_security_user_has_permission(
    ...
    set_identifier___to_verify={'documentation_document_list', }
)
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'documentation_document_list', 'documentation_document_update', }
)
def table_tbody_and_pagination_tree_reload(request):
    return administration_utils.jsonresponse_template_div_center_div_content_table_tbody_and_pagination_tree_reload(
        request=request,
        utils_module=administration_module_utils,
        utils_module_model=administration_module_model_utils
    )
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'documentation_document_list', 'documentation_document_create', }
)
def create(request):
    return administration_utils.jsonresponse_template_div_modal_create(
        request=request,
        utils_module=administration_module_utils,
        utils_module_model=administration_module_model_utils
    )
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'documentation_document_list', 'documentation_document_detail', }
)
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'documentation_document_list', 'documentation_document_delete', }
)
def delete(request, pk):
    return administration_utils.jsonresponse_template_div_modal_delete(
        request=request,
        utils_module=administration_module_utils,
        utils_module_model=administration_module_model_utils,
        pk=pk
