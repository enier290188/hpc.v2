...
@security_decorators.required_security_user_has_permission(
    ...
    set_identifier___to_verify={'security_requestedlocaluser_list', }
)
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'security_requestedlocaluser_list', 'security_requestedlocaluser_detail', }
)
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'security_requestedlocaluser_list', 'security_requestedlocaluser_approve', }
)
def approve(request, pk):
    return administration_utils.jsonresponse_template_div_modal_approve(
        request=request,
        utils_module=administration_module_utils,
        utils_module_model=administration_module_model_utils,
        pk=pk
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'security_requestedlocaluser_list', 'security_requestedlocaluser_disapprove', }
)
def disapprove(request, pk):
    return administration_utils.jsonresponse_template_div_modal_disapprove(
        request=request,
        utils_module=administration_module_utils,
        utils_module_model=administration_module_model_utils,
        pk=pk
