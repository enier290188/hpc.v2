...
@security_decorators.required_security_user_has_permission(
    ...
    set_identifier___to_verify={'security_requestedldapuser_list', }
)
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'security_requestedldapuser_list', 'security_requestedldapuser_detail', }
)
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'security_requestedldapuser_list', 'security_requestedldapuser_approve', }
)
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'security_requestedldapuser_list', 'security_requestedldapuser_disapprove', }
)
