...
@security_decorators.required_security_user_has_permission(
    ...
    set_identifier___to_verify={'security_localuser_list', }
)
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'security_localuser_list', 'security_localuser_create', }
)
def create(request):
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'security_localuser_list', 'security_localuser_detail', }
)
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'security_localuser_list', 'security_localuser_update', }
)
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'security_localuser_list', 'security_localuser_delete', }
)
