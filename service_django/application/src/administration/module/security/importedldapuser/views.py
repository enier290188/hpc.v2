...
@security_decorators.required_security_user_has_permission(
    ...
    set_identifier___to_verify={'security_importedldapuser_list', }
)
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'security_importedldapuser_list', 'security_importedldapuser_detail', }
)
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'security_importedldapuser_list', 'security_importedldapuser_update', }
)
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'security_importedldapuser_list', 'security_importedldapuser_delete', }
)
