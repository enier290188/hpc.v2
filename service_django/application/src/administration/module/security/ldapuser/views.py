...
@security_decorators.required_security_user_has_permission(
    ...
    set_identifier___to_verify={'security_ldapuser_list', }
)
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'security_ldapuser_list', 'security_ldapuser_create', }
)
def create(request):
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'security_ldapuser_list', 'security_ldapuser_detail', }
)
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'security_ldapuser_list', 'security_ldapuser_update', }
)
...
@security_decorators.required_security_user_has_permission(
    security_from_module=security_utils.SECURITY_FROM_MODULE_ADMINISTRATION,
    set_identifier___to_verify={'security_ldapuser_list', 'security_ldapuser_delete', }
)
